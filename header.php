...
<head>
  ...
  <script type="application/ld+json">
    {
      ...
      "alternateName": "creative ui, creative ui design, creative ui design llc, creativeuidesignllc, creativeuidesign",
      "url": "https://creativeuidesign.com/",
      "logo": "https://creativeuidesign.com/wp-content/uploads/2023/01/cud-logo.webp",
      "contactPoint": {
        "@type": "ContactPoint",
      ...
      "sameAs": [
        ...
        "https://twitter.com/creativeuillc",
        "https://www.instagram.com/creativeuidesignllc/",
        "https://www.youtube.com/channel/UC8Gvn4JM1-Gpz-jNAx-vp8w",
        "https://www.linkedin.com/company/creative-ui-design-llc/",
        "https://www.pinterest.com/creativeuidesignus/",
        "https://dribbble.com/creativeuidesignllc",
        "https://www.behance.net/creativeuidesignllc",
        "https://creativeuidesign.com/"
      ]
    }
  </script>
  <script type="application/ld+json">
  ...
  <script>
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-TLBRX28');
  </script>
...
<body <?php body_class(); ?>>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TLBRX28" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
  ...
  <header class="cud-header w-100 position-fixed top-0 start-0 d-flex flex-row flex-wrap justify-content-between align-items-center z-3 px-3">
    ...
    echo wp_nav_menu(array(
      'menu'        => 'Main Menu',
      'menu_id'     => 'nav',
      'menu_class'  => 'cud-nav d-flex flex-row flex-wrap justify-content-center align-items-center w-auto m-0',
      'fallback_cb' => false,
      'container_class' => 'd-xxl-flex d-xl-flex d-none'
      // 'depth'       => 1,
    ));
    ?>
    <div class="cud-actions d-flex flex-row flex-wrap align-items-center gap-3">
      <?php if (have_rows('links', 'option')) : ?>
        <?php $i = 0;
        while (have_rows('links', 'option')) : the_row();
          $i++;
          if ($i == 1) : ?>
            <a href="<?php echo the_sub_field('link_action'); ?>" target="_blank" class="cud-book btn btn-blue btn-sm d-flex align-items-center gap-2" title="Book Meeting">
              ...
              <span class="d-xxl-flex d-xl-flex d-lg-flex d-md-flex d-none">Book Meeting</span>
            </a>
        <?php
          endif;
        endwhile; ?>
      <?php endif; ?>
      <span class="cud-menu-icon cud-trigger border-0 d-xxl-none d-xl-none d-flex flex-row flex-wrap justify-content-center align-items-center">
